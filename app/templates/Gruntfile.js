module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		modernizr: {
			devFile: 'app/wp-content/themes/<%%= yeomanConfig.themeName %>/scripts/vendor/modernizr/modernizr.js',
			outputFile: '<%%= yeomanConfig.dist %>/scripts/vendor/modernizr/modernizr.js',
			files: [
				'<%%= yeomanConfig.dist %>/scripts/{,*/}*.js',
				'<%%= yeomanConfig.dist %>/styles/{,*/}*.css',
